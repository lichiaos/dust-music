  ...
  methods: {
    ...
    progressMove(e) {
      ...
      const offsetWidth = Math.min(
        this.$refs.progressBar.clientWidth - BAR_WIDTH,
    ...
    _progressChange() {
      const barWrapperWidth = this.$refs.progressBar.clientWidth - BAR_WIDTH
      const percent = this.$refs.progress.clientWidth / barWrapperWidth
